                ...
                <CardHeader className="text-center w-full p-0">
                  <div className="flex flex-row items-center">
                    <Image
                      ...
                      width={64}
                      height={64}
                      className="h-16 w-16 mr-4 ml-12"
                      unoptimized
                    />
                          ...
                          .map((section, index) => (
                            <div key={index} className="flex items-start mt-4">
                              <Image
                                ...
                                width={16}
                                height={16}
                                className="h-4 w-4 mr-2 flex-shrink-0 mt-1"
                                unoptimized
                              />
              ...
              <div className="flex flex-col space-y-8 p-5">
                <div className="text-left pl-4">
                  <Image
                    ...
                    width={48}
                    height={48}
                    className="h-12 w-12 mr-6 ml-24"
                    unoptimized
                  />
                  <div className="flex flex-row items-center mb-4">
                    <h3 className="text-2xl text-center font-semibold ml-10">{data.HolisticGrowth}</h3>
                  </div>
                  {data.HolisticGrowthdesc.slice(0, showMoreHolistic ? data.HolisticGrowthdesc.length : 1).map(
                    (paragraph, index) => (
                ...
                <div className="text-left pl-4">
                  ...
                  {data.SpecialNeedsdesc.slice(0, showMoreSpecialNeeds ? data.SpecialNeedsdesc.length : 1).map(
                    (paragraph, index) => (
                      <p key={index} className="text-base text-gray-600 text-justify max-w-[250px] mt-4">
                        {paragraph.children[0].text}
                      </p>
                ...
                <div className="text-left pl-4">
                  ...
                  {data.Learningevtdesc.slice(0, showMoreLearningEnv ? data.Learningevtdesc.length : 3).map(
                    (paragraph, index) => (
        ...
        <>
          <section className="relative">
            ...
            <div className="text-center mt-16 ml-4">
              <p className="text-base font-normal text-left mt-2 px-4">{data.aboutmotto}</p>
          ...
          <section className="mt-14">
            <div className="our-commitment ml-4 p-4">
              <h1 className="text-2xl text-[#006400] text-left font-bold">{data.Commitment}</h1>
              <p className="text-lg text-left mt-4">{data.FosteringGrowth}</p>
