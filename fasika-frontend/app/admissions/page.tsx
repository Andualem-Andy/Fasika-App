          ...
          <div className="hidden md:block lg:hidden">
            ...
            <div className="w-full text-center">
              ...
              <div className="w-full overflow-x-hidden relative" style={{ height: 'auto', overflow: 'hidden' }}>
                ...
                {/* Grid for Icons */}
                <div className="grid grid-cols-2 gap-2 -mt-8 -mb-10 ml-16 px-16">
              ...
              <div className="bg-yellow-50 py-12">
                <div className="flex flex-col text-center p-8">
                  ...
                  <p className="text-[#073F27] text-lg text-center font-bold mb-4 ml-8">{data?.ItemRequired}</p>
                  {data?.RequiredDesc?.split('---').map((desc, index) => (
                    <p key={index} className="text-[#073F27] text-center text-lg font-bold text-left ml-8">
                      {desc.trim()}
                    </p>
                  ))}
                  <div className="flex flex-col mt-8 p-4 px-32">
                    <div className="flex items-start ">
